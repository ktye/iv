...
func selection(f func(*apl.Apl, apl.Value, apl.Value) (apl.Value, error)) func(*apl.Apl, apl.Value, apl.Value) (apl.IntArray, error) {
	return func(a *apl.Apl, L apl.Value, R apl.Value) (apl.IntArray, error) {
